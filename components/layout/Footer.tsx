  ...
  return (
    <footer className="bg-ink text-surface">
      <div className="container py-12">
        ...
        >
          ...
          <div>
            ...
            <div className="flex gap-3" dir="ltr">
              <a
                href="#"
                className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center hover:bg-accent-600 transition-colors duration-200"
                aria-label="Twitter"
              >
                <svg
                  className="w-5 h-5"
        ...
        <div className="border-t border-surface-200 mt-8 pt-8 text-center text-muted">
          <p>
